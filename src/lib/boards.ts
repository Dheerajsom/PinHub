...
const esp32DevKitCHeaders: Pinout = {
  ...
  notes: [
    ...
    "Espressif lists IO16-IO23 as plain GPIO; the VSPI, UART2, and SDA/SCL names are the ESP32 IO_MUX and Arduino-ESP32 defaults, and the GPIO matrix can route these buses to other pins.",
  ],
  groups: [
    {
      label: "J2",
    ...
    },
    {
      ...
      pins: [
        ...
        { position: 2, label: "IO23", role: "spi", aliases: ["GPIO23", "VSPI MOSI"] },
        { position: 3, label: "IO22", role: "i2c", aliases: ["GPIO22", "SCL"] },
        { position: 4, label: "TX", role: "uart", aliases: ["GPIO1", "U0TXD"] },
        { position: 5, label: "RX", role: "uart", aliases: ["GPIO3", "U0RXD"] },
        { position: 6, label: "IO21", role: "i2c", aliases: ["GPIO21", "SDA"] },
        { position: 7, label: "GND", role: "ground" },
        { position: 8, label: "IO19", role: "spi", aliases: ["GPIO19", "VSPI MISO"] },
        { position: 9, label: "IO18", role: "spi", aliases: ["GPIO18", "VSPI CLK"] },
        { position: 10, label: "IO5", role: "system", aliases: ["GPIO5"], note: "Boot strap" },
        { position: 11, label: "IO17", role: "uart", aliases: ["GPIO17", "UART2 TX"], note: "Reserved on ESP32-WROVER modules" },
        { position: 12, label: "IO16", role: "uart", aliases: ["GPIO16", "UART2 RX"], note: "Reserved on ESP32-WROVER modules" },
  ...
  groups: [
    {
      ...
      pins: [
        { position: 1, label: "D0", role: "uart", aliases: ["RX"], note: "Shares USART2 with the ST-LINK virtual COM port; check the manual solder bridges before wiring a shield UART" },
        { position: 2, label: "D1", role: "uart", aliases: ["TX"], note: "Shares USART2 with the ST-LINK virtual COM port; check the manual solder bridges before wiring a shield UART" },
        { position: 3, label: "D2", role: "gpio" },
        { position: 4, label: "D3", role: "pwm" },
        { position: 5, label: "D4", role: "gpio" },
        { position: 6, label: "D5", role: "pwm" },
        ...
        { position: 9, label: "D8", role: "gpio" },
        { position: 10, label: "D9", role: "pwm" },
        { position: 11, label: "D10", role: "spi", aliases: ["SPI CS"] },
        { position: 12, label: "D11", role: "spi", aliases: ["SPI MOSI"] },
        { position: 13, label: "D12", role: "spi", aliases: ["SPI MISO"] },
        { position: 14, label: "D13", role: "spi", aliases: ["SPI SCK"], note: "Also drives user LED LD2, so the LED flickers with SPI clock traffic" },
        { position: 15, label: "GND", role: "ground" },
...
// NUCLEO-H753ZI (MB1364) ST Zio connectors, transcribed from ST UM2407 Rev 4
// Tables 18-21 and cross-checked against the Figure 16 signal map. Pin
// positions are the physical numbers on each connector (odd/even columns
// interleaved, pin 1 at the top of every header).
const nucleoH753ZiZio: Pinout = {
  connector: "ST Zio connectors CN7, CN8, CN9, CN10",
  layout: "grouped",
  notes: [
    "Zio tables follow ST UM2407 Rev 4 for the MB1364 board (NUCLEO-H723ZG / H743ZI2 / H753ZI).",
    "A0-A5 and D0-D15 are the Arduino Uno V3 subset; A6-A8 and D16-D72 are the Zio extension.",
    "Every MCU pin also fans out to the ST morpho headers CN11/CN12 (UM2407 Table 22).",
    "The Ethernet PHY claims PA1, PA2, PC1, PC4, PC5, PG11, PG13, PA7, and PB13 through default-ON solder bridges.",
  ],
  groups: [
    {
      label: "CN7 Zio (upper right)",
      pins: [
        { position: 1, label: "D16 / PC6", role: "special", aliases: ["I2S2 MCK", "I2S_A_MCK"] },
        { position: 2, label: "D15 / PB8", role: "i2c", aliases: ["I2C1 SCL", "I2C_A_SCL"] },
        { position: 3, label: "D17 / PB15", role: "special", aliases: ["I2S2 SD", "I2S_A_SD"] },
        { position: 4, label: "D14 / PB9", role: "i2c", aliases: ["I2C1 SDA", "I2C_A_SDA"] },
        {
          position: 5,
          label: "D18 / PB13",
          role: "special",
          aliases: ["I2S2 CK", "I2S_A_CK"],
          note: "JP6 ON routes PB13 to the Ethernet PHY as RMII_TXD1 — Ethernet and I2S_A cannot be used together.",
        },
        {
          position: 6,
          label: "VREF+",
          role: "power",
          aliases: ["VDDA"],
          note: "Remove R37 before letting a shield drive VREF+ (UM2407).",
        },
        { position: 7, label: "D19 / PB12", role: "special", aliases: ["I2S2 WS", "I2S_A_WS"] },
        { position: 8, label: "GND", role: "ground" },
        { position: 9, label: "D20 / PA15", role: "special", aliases: ["I2S3 WS", "I2S_B_WS"] },
        {
          position: 10,
          label: "D13 / PA5",
          role: "spi",
          aliases: ["SPI1 SCK", "SPI_A_SCK"],
          note: "PA5 is also DAC1_OUT2.",
        },
        { position: 11, label: "D21 / PC7", role: "special", aliases: ["I2S3 MCK", "I2S_B_MCK"] },
        { position: 12, label: "D12 / PA6", role: "spi", aliases: ["SPI1 MISO", "SPI_A_MISO"] },
        {
          position: 13,
          label: "D22 / PB5",
          role: "spi",
          aliases: ["SPI3 MOSI", "I2S_B_SD"],
          note: "Shares PB5 with D11 (CN7 pin 14); use only one at a time.",
        },
        {
          position: 14,
          label: "D11 / PB5",
          role: "spi",
          aliases: ["SPI1 MOSI", "TIM3 CH2", "TIM_E_PWM1"],
          note: "Shares PB5 with D22. SB31 can route PA7 here instead, but PA7 is the Ethernet RMII_CRS_DV signal.",
        },
        { position: 15, label: "D23 / PB3", role: "spi", aliases: ["SPI3 SCK", "I2S_B_CK"] },
        { position: 16, label: "D10 / PD14", role: "spi", aliases: ["SPI1 CS", "TIM4 CH3", "TIM_B_PWM3"] },
        {
          position: 17,
          label: "D24 / PA4",
          role: "spi",
          aliases: ["SPI3 NSS", "SPI_B_NSS"],
          note: "PA4 is also DAC1_OUT1.",
        },
        { position: 18, label: "D9 / PD15", role: "pwm", aliases: ["TIM4 CH4", "TIM_B_PWM2"] },
        { position: 19, label: "D25 / PB4", role: "spi", aliases: ["SPI3 MISO", "SPI_B_MISO"] },
        { position: 20, label: "D8 / PF3", role: "gpio" },
      ],
    },
    {
      label: "CN8 Zio (upper left)",
      pins: [
        { position: 1, label: "NC", role: "reserved" },
        { position: 2, label: "D43 / PC8", role: "special", aliases: ["SDMMC_D0"] },
        { position: 3, label: "IOREF", role: "power", note: "3.3 V reference for shields." },
        { position: 4, label: "D44 / PC9", role: "special", aliases: ["SDMMC_D1", "I2S_CKIN"] },
        { position: 5, label: "NRST", role: "system" },
        { position: 6, label: "D45 / PC10", role: "special", aliases: ["SDMMC_D2"] },
        { position: 7, label: "3V3", role: "power" },
        { position: 8, label: "D46 / PC11", role: "special", aliases: ["SDMMC_D3"] },
        { position: 9, label: "5V", role: "power" },
        { position: 10, label: "D47 / PC12", role: "special", aliases: ["SDMMC_CK"] },
        { position: 11, label: "GND", role: "ground" },
        { position: 12, label: "D48 / PD2", role: "special", aliases: ["SDMMC_CMD"] },
        { position: 13, label: "GND", role: "ground" },
        { position: 14, label: "D49 / PG2", role: "gpio" },
        { position: 15, label: "VIN", role: "power", note: "7-12 V external input." },
        { position: 16, label: "D50 / PG3", role: "gpio" },
      ],
    },
    {
      label: "CN9 Zio (lower left)",
      pins: [
        { position: 1, label: "A0 / PA3", role: "adc", aliases: ["ADC12_INP15"] },
        { position: 2, label: "D51 / PD7", role: "uart", aliases: ["USART2 SCLK", "USART_B_SCLK"] },
        { position: 3, label: "A1 / PC0", role: "adc", aliases: ["ADC123_INP10"] },
        { position: 4, label: "D52 / PD6", role: "uart", aliases: ["USART2 RX", "USART_B_RX"] },
        { position: 5, label: "A2 / PC3", role: "adc", aliases: ["ADC12_INP13"] },
        { position: 6, label: "D53 / PD5", role: "uart", aliases: ["USART2 TX", "USART_B_TX"] },
        { position: 7, label: "A3 / PB1", role: "adc", aliases: ["ADC12_INP5"] },
        { position: 8, label: "D54 / PD4", role: "uart", aliases: ["USART2 RTS", "USART_B_RTS"] },
        {
          position: 9,
          label: "A4 / PC2",
          role: "adc",
          aliases: ["ADC123_INP12"],
          note: "SB53 ON by default; SB55 reroutes A4 to PB9 (I2C1_SDA) for Arduino shields.",
        },
        { position: 10, label: "D55 / PD3", role: "uart", aliases: ["USART2 CTS", "USART_B_CTS"] },
        {
          position: 11,
          label: "A5 / PF10",
          role: "adc",
          aliases: ["ADC3_INP6"],
          note: "SB60 ON by default; SB62 reroutes A5 to PB8 (I2C1_SCL) for Arduino shields.",
        },
        { position: 12, label: "GND", role: "ground" },
        {
          position: 13,
          ...
          role: "special",
          aliases: ["COMP1_INP"],
          note: "PB2 is also QSPI_CLK (D27) on CN10 pin 15.",
        },
        {
          position: 14,
          label: "D56 / PE2",
          role: "special",
          aliases: ["SAI1 A MCLK", "SAI_A_MCLK"],
          note: "PE2 is shared with QSPI_BK1_IO2 (D31) on CN10 pin 25; use only one.",
        },
        {
          position: 15,
          label: "D71 / PE9",
          role: "special",
          aliases: ["COMP2_INP"],
          note: "PE9 is also TIM1_CH1 (D6) on CN10 pin 4.",
        },
        { position: 16, label: "D57 / PE4", role: "special", aliases: ["SAI1 A FS", "SAI_A_FS"] },
        { position: 17, label: "D70 / PF2", role: "i2c", aliases: ["I2C2 SMBA", "I2C_B_SMBA"] },
        { position: 18, label: "D58 / PE5", role: "special", aliases: ["SAI1 A SCK", "SAI_A_SCK"] },
        { position: 19, label: "D69 / PF1", role: "i2c", aliases: ["I2C2 SCL", "I2C_B_SCL"] },
        {
          position: 20,
          label: "D59 / PE6",
          role: "special",
          aliases: ["SAI1 A SD", "SAI_A_SD"],
          note: "PE6 is also TIM1_BKIN2 (D38) on CN10 pin 28.",
        },
        { position: 21, label: "D68 / PF0", role: "i2c", aliases: ["I2C2 SDA", "I2C_B_SDA"] },
        { position: 22, label: "D60 / PE3", role: "special", aliases: ["SAI1 B SD", "SAI_B_SD"] },
        { position: 23, label: "GND", role: "ground" },
        { position: 24, label: "D61 / PF8", role: "special", aliases: ["SAI1 B SCK", "SAI_B_SCK"] },
        { position: 25, label: "D67 / PD0", role: "special", aliases: ["CAN1 RX", "FDCAN1 RX"] },
        { position: 26, label: "D62 / PF7", role: "special", aliases: ["SAI1 B MCLK", "SAI_B_MCLK"] },
        { position: 27, label: "D66 / PD1", role: "special", aliases: ["CAN1 TX", "FDCAN1 TX"] },
        { position: 28, label: "D63 / PF9", role: "special", aliases: ["SAI1 B FS", "SAI_B_FS"] },
        { position: 29, label: "D65 / PG0", role: "gpio" },
        { position: 30, label: "D64 / PG1", role: "gpio" },
      ],
    },
    {
      label: "CN10 Zio (lower right)",
      pins: [
        { position: 1, label: "AVDD", role: "power", note: "Analog supply rail." },
        { position: 2, label: "D7 / PG12", role: "gpio" },
        { position: 3, label: "AGND", role: "ground" },
        {
          position: 4,
          label: "D6 / PE9",
          role: "pwm",
          aliases: ["TIM1 CH1", "TIMER_A_PWM1"],
          note: "PE9 is also COMP2_INP (D71) on CN9 pin 15.",
        },
        { position: 5, label: "GND", role: "ground" },
        { position: 6, label: "D5 / PE11", role: "pwm", aliases: ["TIM1 CH2", "TIMER_A_PWM2"] },
        { position: 7, label: "A6 / PF4", role: "adc", aliases: ["ADC3_INP9"] },
        { position: 8, label: "D4 / PE14", role: "gpio" },
        { position: 9, label: "A7 / PF5", role: "adc", aliases: ["ADC3_INP4"] },
        { position: 10, label: "D3 / PE13", role: "pwm", aliases: ["TIM1 CH3", "TIMER_A_PWM3"] },
        { position: 11, label: "A8 / PF6", role: "adc", aliases: ["ADC3_INP8"] },
        { position: 12, label: "D2 / PG14", role: "gpio" },
        { position: 13, label: "D26 / PG6", role: "spi", aliases: ["QSPI1 NCS", "QSPI_CS"] },
        { position: 14, label: "D1 / PB6", role: "uart", aliases: ["LPUART1 TX", "USART_A_TX"] },
        {
          position: 15,
          label: "D27 / PB2",
          role: "spi",
          aliases: ["QSPI1 CLK", "QSPI_CLK"],
          note: "PB2 is also COMP1_INP (D72) on CN9 pin 13.",
        },
        { position: 16, label: "D0 / PB7", role: "uart", aliases: ["LPUART1 RX", "USART_A_RX"] },
        { position: 17, label: "GND", role: "ground" },
        { position: 18, label: "D42 / PE8", role: "pwm", aliases: ["TIM1 CH1N", "TIMER_A_PWM1N"] },
        { position: 19, label: "D28 / PD13", role: "spi", aliases: ["QSPI1 IO3", "QSPI_BK1_IO3"] },
        { position: 20, label: "D41 / PE7", role: "special", aliases: ["TIM1 ETR", "TIMER_A_ETR"] },
        { position: 21, label: "D29 / PD12", role: "spi", aliases: ["QSPI1 IO1", "QSPI_BK1_IO1"] },
        { position: 22, label: "GND", role: "ground" },
        { position: 23, label: "D30 / PD11", role: "spi", aliases: ["QSPI1 IO0", "QSPI_BK1_IO0"] },
        { position: 24, label: "D40 / PE10", role: "pwm", aliases: ["TIM1 CH2N", "TIMER_A_PWM2N"] },
        {
          position: 25,
          label: "D31 / PE2",
          role: "spi",
          aliases: ["QSPI1 IO2", "QSPI_BK1_IO2"],
          note: "PE2 is shared with SAI_A_MCLK (D56) on CN9 pin 14; use only one.",
        },
        { position: 26, label: "D39 / PE12", role: "pwm", aliases: ["TIM1 CH3N", "TIMER_A_PWM3N"] },
        { position: 27, label: "GND", role: "ground" },
        {
          position: 28,
          label: "D38 / PE6",
          role: "special",
          aliases: ["TIM1 BKIN2", "TIMER_A_BKIN2"],
          note: "PE6 is also SAI_A_SD (D59) on CN9 pin 20.",
        },
        { position: 29, label: "D32 / PA0", role: "pwm", aliases: ["TIM2 CH1", "TIM_C_PWM1"] },
        { position: 30, label: "D37 / PE15", role: "special", aliases: ["TIM1 BKIN1", "TIMER_A_BKIN1"] },
        { position: 31, label: "D33 / PB0", role: "pwm", aliases: ["TIM3 CH3", "TIM_D_PWM1"] },
        { position: 32, label: "D36 / PB10", role: "pwm", aliases: ["TIM2 CH3", "TIMER_C_PWM2"] },
        { position: 33, label: "D34 / PE0", role: "special", aliases: ["TIM4 ETR", "TIM_B_ETR"] },
        { position: 34, label: "D35 / PB11", role: "pwm", aliases: ["TIM2 CH4", "TIMER_C_PWM3"] },
      ],
    },
  ],
};
...
const expansionBoards: Board[] = [
  ...
  },
  {
    ...
    vendor: "STMicroelectronics",
    category: "Development Board",
    family: "STM32 Nucleo-144",
    processor: "STM32H753ZI Arm Cortex-M7 (480 MHz)",
    logicLevel: "3.3 V GPIO (1.8 V selectable via JP5)",
    power: "USB, VIN 7-12 V, 5V_EXT, 3V3_EXT",
    formFactor: "Nucleo-144 with ST Zio + ST morpho headers",
    description:
      "ST's flagship Nucleo-144 for the 480 MHz STM32H753, exposing 100 Zio signals plus full ST morpho fan-out, onboard Ethernet, and the integrated STLINK-V3E debugger.",
    tags: ["STM32", "Nucleo-144", "STM32H7", "Cortex-M7", "Zio", "Ethernet"],
    interfaces: [
      "GPIO",
      "I2C",
      "SPI",
    ...
    highlights: [
      "ST Zio connectors extend Arduino Uno V3 with A6-A8 and D16-D72 (UM2407 Tables 18-21).",
      "Integrated STLINK-V3E gives debug, mass-storage programming, and a virtual COM port with no external probe.",
      "Onboard Ethernet RMII PHY, USB OTG_FS, and SDMMC-capable Zio pins for connectivity work.",
      "480 MHz Cortex-M7 with the H753's hardware crypto/hash accelerators.",
    ],
    warnings: [
      "I/Os are 3.3 V (1.8 V if JP5 is moved) — not 5 V tolerant like Arduino Uno V3 shields expect.",
      "Ethernet RMII solder bridges are ON by default: PA1, PA2, PC1, PC4, PC5, PG11, PG13, PA7, and PB13 (JP6) are tied to the PHY.",
      "Several MCU pins reach two Zio positions (PB5 on D11/D22, PE2 on D31/D56, PB2 on D27/D72, PE9 on D6/D71, PE6 on D38/D59) — drive only one at a time.",
      "A4/A5 route to PC2/PF10 ADC inputs by default; I2C1 on PB9/PB8 needs the SB53/SB55/SB60/SB62 solder-bridge swap.",
      "PA13/PA14 are the STLINK-V3E SWD pins; ST advises against using them as I/O.",
      "This map is for the MB1364 board (NUCLEO-H753ZI / H743ZI2); the older MB1137 NUCLEO-H743ZI in UM1974 differs.",
    ],
    sourceLinks: [
      {
        label: "ST NUCLEO-H753ZI product page",
        url: "https://www.st.com/en/evaluation-tools/nucleo-h753zi.html",
        type: "Docs",
      },
      {
        label: "ST STM32H7 Nucleo-144 user manual UM2407 (MB1364)",
        url: "https://www.st.com/resource/en/user_manual/um2407-stm32h7-nucleo144-boards-mb1364-stmicroelectronics.pdf",
        type: "Manual",
      },
      {
        label: "STM32H753ZI datasheet",
        url: "https://www.st.com/resource/en/datasheet/stm32h753zi.pdf",
        type: "Datasheet",
      },
    ],
    pinout: nucleoH753ZiZio,
  },
  {
